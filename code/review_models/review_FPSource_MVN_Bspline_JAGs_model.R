...
# fit_sim model -----------------------------------------
vispath = 'visualisations/country_data/MVN/JAGS/'

# fit_sim model -----------------------------------------
fit_sim <- readRDS('results/JAGS/JAGS_model_4country_MVN_NCP_kstar_SE.RDS')
...
mcmc_trace(jags.fit.mcmc, pars= c('err_alpha_pmslpha_cms[1,1]', 'err_alpha_pmslpha_cms[2,1]', 'err_alpha_pmslpha_cms[3,1]', 'err_alpha_pmslpha_cms[4,1]', 'err_alpha_pmslpha_cms[5,1]'))
mcmc_trace(jags.fit.mcmc, pars= c('err_alpha_pmslpha_cms[1,1]', 'err_alpha_pmslpha_cms[1,2]', 'err_alpha_pmslpha_cms[1,3]', 'err_alpha_pmslpha_cms[1,4]', 'err_alpha_pmslpha_cms[1,5]'))
...
ggsave(filename = "betac_plot_4country_.pdf", path = vispath, height=12, width=15) 
...
pdf(paste0(vispath, "posterior_predictive_observed_4country_MVN.pdf")) 
plot(y_sim_mean, y_obs)
abline(a=0, b=1, col='red')
dev.off()

pdf(paste0(vispath,"posterior_predictive_check_4country_MVN.pdf"))
...
saveRDS(P_samps_df, file='results/JAGS/P_samps/JAGS_model_4country_MVN_Psamps_df.RDS')
