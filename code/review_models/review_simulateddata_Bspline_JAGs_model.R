...
vispath='visualisations/simulated_data/bspline/JAGS/10years/'

# fit_sim model -----------------------------------------
fit_sim <- readRDS('results/JAGS/JAGS_model_KenyaSim_Bspline_10years.RDS')
...
ggsave(filename = "betac_plot_Kenyasim_10years_bspline.pdf", path = vispath, height=12, width=15) 
...
jags.fit.mcmc %>%
  ...
  facet_wrap(~Parameter)
ggsave(filename = "a0_plot_Kenyasim_10years_bspline.pdf", path = vispath, height=12, width=15) 
...
pdf(paste0(vispath, "posterior_predictive_observed_Kenyasim_10years_bspline.pdf")) 
plot(y_sim_mean, y_obs)
abline(a=0, b=1, col='red')
dev.off()

pdf(paste0(vispath,"posterior_predictive_check_Kenyasim_10years_bspline.pdf"))
...
ggsave(filename = "p_plot_Kenyasim_sum0_10years_bspline.pdf", path = vispath, height=12, width=15) 
