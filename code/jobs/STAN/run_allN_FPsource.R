...
fit <- stan(
  file = "model/STAN/kstar_spline_public_private_logit_allN_SE.stan",  # Stan program
...
saveRDS(fit, file='results/STAN_model_kstar_N_alpha_N_delta_FPsource_Bikarray_KenyaCameroon.RDS')
