...
transformed parameters { 
  ...
  cholesky_factor_cov[M_count] L_Sigma_beta; // cholesky decomp. of covariance
  cholesky_factor_cov[M_count] L_Sigma_delta; // cholesky decomp. of covariance
