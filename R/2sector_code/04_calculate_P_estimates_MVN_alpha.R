...
n_samps=4000
z <- array(NA, dim=c(n_samps, length(n_method), length(n_subnat), length(all_years)))
P <- array(NA, dim=c(n_samps, 2, length(n_method), length(n_subnat), length(all_years)))
